...
SPIN_SCENARIOS = {
    ...
    "3. Назначает конкурента: ГЕРБИОН": {
        ...
        "key_facts": "Проблема: В Гербионе не комбинация, а либо мох 1.69%, либо подорожник 3.97%. Выгода: В нашем препарате в 1.8 раза больше подорожника и в 1.6 раз больше мха."
    },
