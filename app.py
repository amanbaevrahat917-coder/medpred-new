...
SPIN_SCENARIOS = {
    ...
    "2. Назначает конкурента: МУНАТОРИЛ": {
        ...
        "expected_doctor_answers": "Говорят про задержку мокроты -> 'Усиливается кашель, чаще по ночам'. Спрашивают про состояние мамы и ребенка утром -> 'Обструкция, одышка, придется подключать гормоны,мама раздраженная'.",
